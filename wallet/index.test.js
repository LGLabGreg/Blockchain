...
describe('Wallet', () => {
  ...
  describe('calcualting a balance', () => {
    ...
    it('calculates the balance for blockchin transactions matching the recipient', () => {
      expect(wallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE + addBalance * repeatAdd);
    });

    it('calculates the balance for blockchin transactions matching the sender', () => {
